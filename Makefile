# This Makefile is for the Device::Opto22 extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Device/Opto22.pm]
#     AUTHOR => q[root <root@localdomain>]
#     BUILD_REQUIRES => {  }
#     NAME => q[Device::Opto22]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Device/Opto22.pm]
...
MAKE = make
FULLEXT = Device/Opto22
BASEEXT = Opto22
PARENT_NAME = Device
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Device/Opto22.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Device/Opto22.pm \
	lib/Device/Opto22/Firewire.pm

PM_TO_BLIB = lib/Device/Opto22/Firewire.pm \
	blib/lib/Device/Opto22/Firewire.pm \
	lib/Device/Opto22.pm \
...
DISTNAME = Device-Opto22
DISTVNAME = Device-Opto22-0.90
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Device/Opto22.pm $(INST_MAN3DIR)/Device::Opto22.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Device-Opto22' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.90' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.90">' > $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Device/Opto22/Firewire.pm blib/lib/Device/Opto22/Firewire.pm \
	  lib/Device/Opto22.pm blib/lib/Device/Opto22.pm 
